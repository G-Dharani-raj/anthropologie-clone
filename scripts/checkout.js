...
function shippingList(email, country, firstName, lastName, address1, address2, cityName, region, postcode, mobileNumber){
    this.email=email;
...
function getData(){
    ...
    addList(email, country, firstName, lastName, address1, address2, cityName, region, postcode, mobileNumber);
}
let customerData=JSON.parse(localStorage.getItem("customer_data"))||[];
function addList(email, country, firstName, lastName, address1, address2, cityName, region, postcode, mobileNumber){

    let data=new shippingList(email, country, firstName, lastName, address1, address2, cityName, region, postcode, mobileNumber);
